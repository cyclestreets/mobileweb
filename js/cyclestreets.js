var cyclestreetsui = (function ($) {
	...
	var _layerConfig = {
		...
		photomap: {
			...
			popupHtml: 
			      '<div class="inner-card flip-card-inner"><div class="flip-card-front popup-card"><a href="#" class="ui-button close-button" title="Close this popup"><img src="/images/icon-cross-red.svg" alt="Close icon" /></a><span class="loader"></span><img class="popup-photo" src="{properties.thumbnailUrl}" alt="Photo" />' 
				+ '<a href="#" title="Share this location"><img src="/images/icon-share.svg" alt="Share icon" /> Share</a><a class="flip" href="#" title="Show more information"> Photo info</a></div>'
