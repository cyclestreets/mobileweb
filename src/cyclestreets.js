...
//			+ '<p>Please do let us know any bugs you find, using the feedback link in the menu.</p>'
	...
	var _layerConfig = {
		...
		photomap: {
			...
			popupHtml:
				  '<div class="data" data-coordinates="{geometry.coordinates}" data-location-id="{properties.id}" data-caption="{properties.caption}" data-shortlink="{properties.shortlink}" data-username="{properties.username}"></div>'
				...
				+ '<a href="#" class="get-directions" title="Get directions to this place"><img class="get-directions" src="/images/btn-get-directions-large.svg" /></a>'
				+ '<p class="key">{properties.caption}</p>'
